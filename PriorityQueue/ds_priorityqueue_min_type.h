...
static inline void destroy_element(const ds_priorityqueue_min_type *e)
{
    (void)e;
}
#define DS_PRIORITYQUEUE_MIN_DESTROY_ELEMENT(e) destroy_element(&(e))

static inline ds_priorityqueue_min_type clone_element(const ds_priorityqueue_min_type *src, int *judge)
{
    (void)judge;
    return *src;
}
#define DS_PRIORITYQUEUE_MIN_CLONE_ELEMENT(e, judge) clone_element(&(e), judge)
