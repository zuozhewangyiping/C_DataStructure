...
#define DS_PRIORITYQUEUE_MAX_DESTROY_ELEMENT(e) destroy_element_max(&(e))

static inline ds_priorityqueue_max_type clone_element_max(const ds_priorityqueue_max_type *src, int *judge)
{
    (void)judge;
    return *src;
}
#define DS_PRIORITYQUEUE_MAX_CLONE_ELEMENT(e, judge) clone_element_max(&(e), judge)
